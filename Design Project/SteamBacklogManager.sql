...
CREATE TABLE IF NOT EXISTS OwnedGames (
  ...
  minutesPlayed2Weeks INT NOT NULL,
...
INSERT INTO OwnedGames(steamID, appID, minutesPlayed, minutesPlayed2Weeks, lastUpdate)
...
INSERT INTO UserGameCompletion(steamID, appID, userGameRank, gameCompleted)
                        VALUES(76561197972495328, 220, 1, TRUE),
...
INSERT INTO UserAchievements(appID, steamID, apiName, achieved)
                      VALUES(220, 76561198055529452, 'HL2_GET_CROWBAR', TRUE),
                            (400, 76561198055529452, 'PORTAL_GET_PORTALGUNS', TRUE),
                            (620, 76561198055529452, 'ACH.WAKE_UP', TRUE),
                            (72850, 76561198055529452, 'NEW_ACHIEVEMENT_8_0', FALSE);

-- Insert some of Robin Walker's achievement completion status data into the database
INSERT INTO UserAchievements(appID, steamID, apiName, achieved)
                      VALUES(220, 76561197972495328, 'HL2_GET_CROWBAR', TRUE),
                            (400, 76561197972495328, 'PORTAL_GET_PORTALGUNS', TRUE),
                            (620, 76561197972495328, 'ACH.WAKE_UP', TRUE),
                            (72850, 76561197972495328, 'NEW_ACHIEVEMENT_8_0', FALSE);
